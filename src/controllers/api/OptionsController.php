...
class OptionsController extends BaseApiController
{
    ...
    public function actionIndex(): Response
    {
        ...
        $response->getHeaders()
            ...
            ->set('Access-Control-Allow-Headers', 'Content-Type,x-craft-host,x-craft-plugin-licenses,x-craft-user-ip,x-craft-system,x-craft-license,x-craft-platform,x-craft-user-email')
